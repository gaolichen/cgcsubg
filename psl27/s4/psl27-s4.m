...
ClaculateAndPrintPslCG[r1_,r2_,r3_, input_,opts:OptionsPattern[]]:=Module[{m,i,rr3},
	CalculateCG[r1,r2,r3,Psl27ToS4,input,{PslGenB},FilterRules[{opts}, Options[CalculateCG]]];
